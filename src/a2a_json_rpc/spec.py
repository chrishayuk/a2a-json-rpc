...
#   timestamp: 2025-09-15T14:32:04+00:00
...
class InternalError(BaseModel):
    code: int = Field(
        -32603, const=True, description='The error code for an internal server error.'
    )
    data: Optional[Any] = Field(
        None,
        description='A primitive or structured value containing additional information about the error.\nThis may be omitted.',
...
class InvalidAgentResponseError(BaseModel):
    code: int = Field(
        -32006, const=True, description='The error code for an invalid agent response.'
    )
    data: Optional[Any] = Field(
        None,
        description='A primitive or structured value containing additional information about the error.\nThis may be omitted.',
...
class InvalidRequestError(BaseModel):
    code: int = Field(
        -32600, const=True, description='The error code for an invalid request.'
    )
    data: Optional[Any] = Field(
        None,
        description='A primitive or structured value containing additional information about the error.\nThis may be omitted.',
...
class JSONParseError(BaseModel):
    code: int = Field(
        -32700, const=True, description='The error code for a JSON parse error.'
    )
    data: Optional[Any] = Field(
        None,
        description='A primitive or structured value containing additional information about the error.\nThis may be omitted.',
...
class MethodNotFoundError(BaseModel):
    code: int = Field(
        -32601, const=True, description='The error code for a method not found error.'
    )
    data: Optional[Any] = Field(
        None,
        description='A primitive or structured value containing additional information about the error.\nThis may be omitted.',
...
class TaskNotFoundError(BaseModel):
    code: int = Field(
        -32001, const=True, description='The error code for a task not found error.'
    )
    data: Optional[Any] = Field(
        None,
        description='A primitive or structured value containing additional information about the error.\nThis may be omitted.',
...
class UnsupportedOperationError(BaseModel):
    code: int = Field(
        -32004, const=True, description='The error code for an unsupported operation.'
    )
    data: Optional[Any] = Field(
        None,
        description='A primitive or structured value containing additional information about the error.\nThis may be omitted.',
...
class GetTaskRequest(BaseModel):
    ...
    method: str = Field(
        'tasks/get', const=True, description="The method name. Must be 'tasks/get'."
    )
...
class GetAuthenticatedExtendedCardResponse(BaseModel):
    __root__: Union[
...
class CancelTaskResponse(BaseModel):
    __root__: Union[JSONRPCErrorResponse, CancelTaskSuccessResponse] = Field(
        ..., description='Represents a JSON-RPC response for the `tasks/cancel` method.'
    )


class GetTaskResponse(BaseModel):
    __root__: Union[JSONRPCErrorResponse, GetTaskSuccessResponse] = Field(
...
class SendMessageResponse(BaseModel):
    __root__: Union[JSONRPCErrorResponse, SendMessageSuccessResponse] = Field(
        ..., description='Represents a JSON-RPC response for the `message/send` method.'
    )


class SendStreamingMessageResponse(BaseModel):
    __root__: Union[JSONRPCErrorResponse, SendStreamingMessageSuccessResponse] = Field(
        ...,
